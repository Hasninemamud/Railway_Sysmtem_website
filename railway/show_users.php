...
echo " <br><button><a href=\"http://localhost/railway/new_user_form.html\"> Add New User </a></button><br> ";
echo " <br><button><a href=\"http://localhost/railway/admin_login.php\">Go Back to Admin Menu</button></a> <br><br>";
?>
</body>
</html>
