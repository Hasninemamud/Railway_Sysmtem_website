<html>
    <link rel="shortcut icon" href="WhatsApp Image 2022-12-05 - Copy" type="image/x-icon">
...
if(mysqli_num_rows($query) == 0)
{
 ...
 echo " <button><a href=\"http://localhost/railway/index.html\">Home Page</a></button><br>";
 die();
}
...
?>
<div class="button">
 <button><a href="http://localhost/railway/index.html">Home Page</a></button><br>
 </div>
