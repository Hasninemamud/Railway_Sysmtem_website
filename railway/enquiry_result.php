<html>
<body style=" background-color: #D4AC0D;
    height: 100%; 
...
{
 echo "There is no such train <br> <br>";
...
<input style="background-color: #0C9A19 ; border-color: #0DD41F;height:25px; width:145px; color:white; text-aling:center" type="submit" value="Proceed with Booking"><br><br>
</form>

<?php

echo "<button> <a href=\"http://localhost/railway/enquiry.php\">More Enquiry</a></button> <br>";

$conn->close(); 
?>

<br><button><a href="http://localhost/railway/index.htmL"> Home Page</a></button><br><br>
</body>
</html>
